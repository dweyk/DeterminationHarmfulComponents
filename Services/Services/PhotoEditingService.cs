...
public class PhotoEditingService : IPhotoEditingService
{
    ...
    /// </param>
    private async Task<string[]> GetCompositionsAsync(string text)
    {
        ...
        return await Task.FromResult(productCompositionsSplit);
    }
    
    /// <summary>
    ///     Получить конфигурацию для нейронной сети
    /// </summary>
    private async Task<(string language, string trainDataPath)> GetConfigAsync()
    {
        ...
        return await Task.FromResult((language, trainDataPath));
    }
}